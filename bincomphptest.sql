...
--
-- Table structure for table `party result`
--

CREATE TABLE `party result` (
  `lga_id` int(90) NOT NULL,
  `polling_unit_id` int(90) NOT NULL,
  `party_id` int(90) NOT NULL,
  `result` int(125) NOT NULL,
...
--
-- Dumping data for table `party result`
--

INSERT INTO `party result` (`lga_id`, `polling_unit_id`, `party_id`, `result`, `name`, `email`, `serial_no`) VALUES
(9, 9, 9, 900, 'john', 'edo@hmaol.com', 1),
(0, 23, 0, 400, 'favour', 'fotata@gmail.com', 2),
(5, 4, 0, 44, 'joseph', 'favour@hmail.com', 3),
(5, 4, 0, 44, 'joseph', 'favour@hmail.com', 4),
(5, 4, 0, 44, 'joseph', 'favour@hmail.com', 5),
(5, 4, 0, 44, 'joseph', 'favour@hmail.com', 6),
(7, 3, 0, 300, 'joseph', 'faota@gmaail.com', 7),
(7, 3, 0, 300, 'joseph', 'faota@gmaail.com', 8),
(7, 3, 0, 300, 'joseph', 'faota@gmaail.com', 9);
...
--
-- Indexes for table `party result`
--
ALTER TABLE `party result`
...
--
-- AUTO_INCREMENT for table `party result`
--
ALTER TABLE `party result`
